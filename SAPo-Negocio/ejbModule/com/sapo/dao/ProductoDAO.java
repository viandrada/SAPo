...
public class ProductoDAO {
	...
	/*
	 * Paso un id de un producto y obtengo el histórico de ese producto. Es
	...
	/*
	 * Paso un id de un producto y obtengo el histórico de las MODIFICACIONES
	 * de ese producto. (sólo las modificaciones) SI SE USA HAY QUE REVISAR
