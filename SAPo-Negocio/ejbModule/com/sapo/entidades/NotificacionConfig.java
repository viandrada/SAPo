 ...
 */
@NamedQueries({
		@NamedQuery(name = "NotificacionConfig.getConfiguraciones", query = "SELECT n FROM NotificacionConfig n WHERE n.usuario.idUsuario = :idUsuario"),
		@NamedQuery(name = "NotificacionConfig.getConfiguracionesPorProducto", query = "SELECT n FROM NotificacionConfig n WHERE n.producto.idProducto = :idProducto")})
@Entity
