...
public class EditarProductoEspBean {
	...
	/* Categor�as para mostrar en los combo box */
	private List<DataCategoria> listDataCat;// Categor�as del usuario
	private List<DataCategoria> listDataCatGeneticas;// Categor�as gen�ricas

	public String nombreCatSeleccionada;// Nombre de la categor�a en caso de
										// crear una nueva
