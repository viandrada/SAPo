...
public class AltaProductoConPlantillaBean {
	...
	public void altaProducto() {
		...
		this.productoNuevo.setIdProductoGenerico(this.productoGenerico.getIdProducto());//Se guarda la referencia al producto gen�rico.
		...
		String json = gson.toJson(this.getAtributosVista());//Se incluyen los que agreg� el usuario a los que ya ten�a el gen�rico.
		...
		//Si no sube imagen, se guarda la del gen�rico.
